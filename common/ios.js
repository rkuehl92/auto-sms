module.exports = class IosDict {
    ...
    containsUserAgent(uaHeader) {
        let result = false;

        Object.values(this.userAgents).map(uaArr => uaArr.map(uaStr => {
            if (uaStr.includes(uaHeader) || /iPad|iPhone|iPod/.test(uaHeader)) {
                result = true;
            }
        }));
